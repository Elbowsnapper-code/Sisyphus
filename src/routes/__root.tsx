...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "A quiet desktop studio for writing novels — manuscript, story library, and the hill.",
      },
      { name: "theme-color", content: "#2c2118" },
    ],
    links: [
